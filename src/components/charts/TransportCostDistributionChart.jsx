...
const TransportCostDistributionChart = () => {
  // Chart Data
  const data = [
    { name: "PostNL", value: 1850, percentage: 54, color: "#10B981" },
    { name: "Own Delivery", value: 1570, percentage: 46, color: "#F97316" },
  ];
...
export default TransportCostDistributionChart;
